...
several, so we list them separately below. Using any of this data also means agreeing to the
[Terms of data access](terms-of-data-access.md).

## Output data

Our outputs, including the downscaled 0.25° data and the coarse bias-corrected data, are licensed
[CC BY 4.0](https://creativecommons.org/licenses/by/4.0/).

## Input data

Input datasets are subject to their respective licenses, which are summarized in the table below. We
share the input datasets with their metadata (including license information) unchanged, even though
some of the datasets’ licenses were updated or added retroactively (see notes in the table and in the
associated DOIs). As a result, the license information in the raw input netCDF files does not
necessarily include or match the licenses included below. If you have questions or concerns
regarding licensing of input datasets, please reach out to the appropriate license holder directly.

| GCM | Scenario | License | Attribution and citation |
| --- | --- | --- | --- |
| `CESM2-WACCM6` | `historical` | CC BY 4.0 | Danabasoglu, Gokhan (2019). NCAR CESM2-WACCM model output prepared for CMIP6 CMIP historical. Version 20191104. Earth System Grid Federation. <https://doi.org/10.22033/ESGF/CMIP6.10071> Note: CC BY-SA 4.0 International License is named in the netCDF file; we understand this licensing is superseded by CC BY 4.0, based on the CMIP6 Terms of Use. |
