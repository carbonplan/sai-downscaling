...
Each `(GCM, obs-dataset, spatial-subset)` combination gets exactly two Icechunk repositories, one for
...
### Config delivery differs between the two remote executors
