...
virtual_ic_prefix = "input/tensor/CESM-G6-1.5K/icechunk/virtual_icechunk"
ic_prefix = "input/tensor/CESM-G6-1.5K/icechunk/icechunk"
...
snapshot_id = session.commit("virtual_CESM-G6-1.5K")
print(snapshot_id)
repo.save_config()
