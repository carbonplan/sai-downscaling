...
def _validation_cluster(
    ...
    *,
    ...
    Reuses :func:`saidownscale.config.setup_cluster` (the canonical SRM Coiled setup, as in
...
def _print_validate_lineage_summary(gcm: str, scenarios: list[str]) -> None:
    ...
    from saidownscale.lineage import ScenarioMember, get_lineage_entries
...
def _render_cost_plan(
    ...
    console.print(
        f"  [dim]Rough estimate only. Rates and durations are hardcoded in src/saidownscale/cost.py "
