...
:mod:`saidownscale.lineage`, not here.
"""
...
from saidownscale.config import VarSpec, VarStandards
...
class Datatree(Dataset):
    ...
    def to_xarray(self, group: str | None = None) -> xr.DataTree | xr.Dataset:  # type: ignore[override]
        import icechunk
        import xarray as xr
