...
class DownscalingOrchestrator:
    ...
    def _submit_batch_job(
        ...
        response = client.submit_job(
            ...
            containerOverrides={
                ...
                "command": ["python", "-m", "saidownscale.batch_runner", stage],
    ...
    def _stage_loc(
        ...
        :meth:`~saidownscale.cache.ArtifactCache.stage_loc`, shared with the pipeline's write path
    ...
    def _submit_to_coiled(
        ...
        saidownscale.batch_runner module. Each task receives its configuration as a
