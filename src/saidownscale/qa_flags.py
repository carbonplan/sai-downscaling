...
# Per-dim view of the pipeline's *current* output chunk/shard shapes. saidownscale.encoding.make_encoding
...
def run_step3(
    ...
    if mode in ["debiased_coarse_only", "both"]:
        ...
        for tag in tags_np_coarse:
            ...
            # (see e.g. saidownscale.cache.debiased_coarse_scenario_loc), so the write group mirrors
