...
class Catalog:
    def __init__(self):
        ...
        self.datasets: dict[str, BaseDataset] = {
            ...
            "CESM2-WACCM-historical-dev-icechunk": Dataset(
                name="CESM2-WACCM-historical-dev-icechunk",
                path="s3://carbonplan-srm/input/tensor/CESM2/dev/CESM2-WACCM-historical-dev.icechunk",
                format="icechunk",
                expected_chunks={"ensemble_member": 1, "time": 30, "lat": 192, "lon": 288},
                expected_shards={"ensemble_member": 1, "time": 480, "lat": 192, "lon": 288},
                expected_vars=self.standard_vars + [VarStandards.DTR],
            ),
            "CESM2-WACCM-SSP245-dev-icechunk": Dataset(
                name="CESM2-WACCM-SSP245-dev-icechunk",
                path="s3://carbonplan-srm/input/tensor/CESM2/dev/CESM2-WACCM-SSP245-dev.icechunk",
                format="icechunk",
                expected_chunks={"ensemble_member": 1, "time": 30, "lat": 192, "lon": 288},
                expected_shards={"ensemble_member": 1, "time": 480, "lat": 192, "lon": 288},
                expected_vars=self.standard_vars + [VarStandards.DTR],
            ),
            "CESM2-WACCM-G6-1.5K-dev-icechunk": Dataset(
                name="CESM2-WACCM-G6-1.5K-dev-icechunk",
                path="s3://carbonplan-srm/input/tensor/CESM2/dev/CESM2-WACCM-G6-1.5K-dev.icechunk",
                format="icechunk",
                expected_chunks={"ensemble_member": 1, "time": 30, "lat": 192, "lon": 288},
                expected_shards={"ensemble_member": 1, "time": 480, "lat": 192, "lon": 288},
                expected_vars=self.standard_vars + [VarStandards.DTR],
            ...
            "pangeo-CESM2-WACCM-historical-dev-icechunk": Dataset(
                name="pangeo-CESM2-WACCM-historical-dev-icechunk",
                path="s3://carbonplan-srm/input/tensor/CESM2/dev/pangeo-CESM2-WACCM-historical-dev.icechunk",
                format="icechunk",
                expected_chunks={"ensemble_member": 1, "time": 30, "lat": 192, "lon": 288},
                expected_shards={"ensemble_member": 1, "time": 480, "lat": 192, "lon": 288},
                expected_vars=[
            ...
            "MIROC-ES2H-esgf-SSP245-dev-icechunk": Dataset(
                name="MIROC-ES2H-esgf-SSP245-dev-icechunk",
                path="s3://carbonplan-srm/input/tensor/MIROC-ES2H/dev/MIROC-ES2H-esgf-SSP245-dev.icechunk",
                format="icechunk",
                expected_chunks={"ensemble_member": 1, "time": 60, "lat": 128, "lon": 256},
                expected_shards={"ensemble_member": 1, "time": 960, "lat": 128, "lon": 256},
                expected_vars=[
            ...
            "MIROC-ES2H-historical-dev-icechunk": Dataset(
                name="MIROC-ES2H-historical-dev-icechunk",
                path="s3://carbonplan-srm/input/tensor/MIROC-ES2H/dev/MIROC-ES2H-historical-dev.icechunk",
                format="icechunk",
                expected_chunks={"ensemble_member": 1, "time": 60, "lat": 128, "lon": 256},
                expected_shards={"ensemble_member": 1, "time": 960, "lat": 128, "lon": 256},
                expected_vars=[
            ...
            "MIROC-ES2H-SSP245-dev-icechunk": Dataset(
                name="MIROC-ES2H-SSP245-dev-icechunk",
                path="s3://carbonplan-srm/input/tensor/MIROC-ES2H/dev/MIROC-ES2H-SSP245-dev.icechunk",
                format="icechunk",
                expected_chunks={"ensemble_member": 1, "time": 60, "lat": 128, "lon": 256},
                expected_shards={"ensemble_member": 1, "time": 960, "lat": 128, "lon": 256},
                expected_vars=[
            ...
            "MIROC-ES2H-G6-1.5K-dev-icechunk": Dataset(
                name="MIROC-ES2H-G6-1.5K-dev-icechunk",
                path="s3://carbonplan-srm/input/tensor/MIROC-ES2H/dev/MIROC-ES2H-G6-1.5K-dev.icechunk",
                format="icechunk",
                expected_chunks={"ensemble_member": 1, "time": 60, "lat": 128, "lon": 256},
                expected_shards={"ensemble_member": 1, "time": 960, "lat": 128, "lon": 256},
                expected_vars=[
