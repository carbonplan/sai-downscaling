...
class BCSDPipeline:
    ...
    def prepare_observations(self, force: bool = False) -> str:
        ...
        """
        output_path = self.cache.get_obs_path(self.config.gcm, self.config.variable)
    ...
    def fit_historical(self, force: bool = False) -> str:
        ...
        output_path = self.cache.get_historical_path(
            self.config.gcm, self.config.variable, self.config.ensemble_member
        )
    ...
    def transform_scenario(self, force: bool = False) -> str:
        ...
        output_path = self.cache.get_scenario_path(
            self.config.gcm, self.config.variable, self.config.ensemble_member, self.config.scenario
        )
