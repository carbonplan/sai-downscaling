...
``CESM2_WACCM_GLOBAL`` records the icechunk store and branch holding the blessed
...
CESM2_WACCM_GLOBAL = GlobalBaseline(
    uri="s3://us-west-2.opendata.source.coop/carbonplan/srm-downscaling/output/production/CESM2-WACCM-ERA5-global.icechunk",
    branch="v0.10.0",
)
